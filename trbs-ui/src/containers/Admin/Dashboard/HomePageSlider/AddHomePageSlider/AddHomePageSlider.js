...
import * as classes from "./AddHomePageSlider.module.css";
import { initalValues } from "./InitialData";

class AddHomePageSlider extends Component {
  state = {
  ...
  render() {
    ...
    return (
      <div className={classes.AddHomePageSlider}>
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(AddHomePageSlider)
);
